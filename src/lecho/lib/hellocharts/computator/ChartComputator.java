...
public class ChartComputator {
     ...
     * Maximum chart zoom.
     */
    protected static final float DEFAULT_MAXIMUM_ZOOM = 60f;
    ...
    protected Viewport minViewport = new Viewport();
    ...
    public Viewport getMinimumViewport() {
        return minViewport;
    }
    ...
    public void setMinViewport(Viewport minViewport) {
        setMinViewport(minViewport.left, minViewport.top, minViewport.right, minViewport.bottom);
    }
    ...
    public void setMinViewport(float left, float top, float right, float bottom) {
        this.minViewport.set(left, top, right, bottom);
        computeMinimumWidthAndHeight();
    }
